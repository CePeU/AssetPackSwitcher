...
Double click will select that asset for moving etc.   
...
I use this manual way of mapping items to do asset swaps that could not be done automatically (for example for assets that changed name).
